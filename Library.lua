...
function Library:SetUIGlowEnabled(enabled)
    self.UIGlowEnabled = enabled == true;

    if self.WindowGlow then
        self.WindowGlow.Visible = self.UIGlowEnabled;
    end;
end;

function Library:SyncUIGlowAccent()
    if self.WindowGlow then
        self.WindowGlow.ImageColor3 = self.AccentColor;
    end;
end;
